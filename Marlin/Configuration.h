...
#define CUSTOM_MACHINE_NAME "HCv5.0 (NP)"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Ki_LIST {  5.83,  5.83 }
    #define DEFAULT_Kd_LIST { 72.30, 72.30 }
  #else
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Custom HyperCube
  #define DEFAULT_bedKp 438.32
  #define DEFAULT_bedKi 74.29
  #define DEFAULT_bedKd 646.53
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {200,  200, 800, 138.6} // TMC, 32, 32 32, 32
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 29, -2, -1.52 }
